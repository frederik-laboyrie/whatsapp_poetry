...
with tf.Session() as sess:
    ...
    # create tensors info
    model_tsl = tf.saved_model.utils.build_tensor_info(target_sequence_length)
    model_keep_prob = tf.saved_model.utils.build_tensor_info(keep_prob)
    ...
    signature_definition = tf.saved_model.signature_def_utils.build_signature_def(
        inputs={'inputs': model_input, 'target_sequence_length': model_tsl, 'keep_prob': model_keep_prob},
        outputs={'predictions': model_output},
